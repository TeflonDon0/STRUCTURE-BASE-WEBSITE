...
app.config.update(
    ...
    ADMIN_USERNAME=os.environ.get("STRUCTUREBASE_ADMIN_USERNAME", DEFAULT_ADMIN_USERNAME),
    ADMIN_PASSWORD=os.environ.get("STRUCTUREBASE_ADMIN_PASSWORD", DEFAULT_ADMIN_PASSWORD),
